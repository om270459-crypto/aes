...
import { Heart, MessageCircle, Gamepad2, Timer, Image as ImageIcon, PenLine, Menu, X } from "lucide-react";
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href}>
              <a className="relative group px-3 py-2 flex flex-col items-center gap-1">
                <item.icon 
